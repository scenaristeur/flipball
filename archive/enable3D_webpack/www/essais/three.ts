...
const MainScene = () => {
  ...
  let box4 = physics.add.box({ depth: 0.25, y: -7, z: 1, x: -3 }, { custom: mat })

  physics.add.constraints.hinge(cylinderL.body, box4.body, {
    pivotA: { y: -0.65 }, //-0.65
    pivotB: { y: 2 }, //0.65
    axisA: { x: 1 },
    axisB: { x: 1 }
  ...
  // physics.add.constraints.hinge(table.body, cylinderL.body, {
  //   pivotA: { y: -2 }, //-0.65
  //   pivotB: { y: 2 }, //0.65
  //   axisA: { x: 1 },
  //   axisB: { x: 1 }
